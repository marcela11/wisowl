<%-- 
    Document   : citasestu
    Created on : 26-feb-2015, 7:58:08
    Author     : Sena
--%>
...
CitaAcademicaDTO cit=new CitaAcademicaDTO();

LinkedList<CitaAcademicaDTO> var=cid.listarcitasEstu();
%>
        <div id="wrapper">
            ...
            <nav class="navbar-default navbar-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        ...
                        <li  >
                            <a   href="ingresoestu.jsp"><i class="fa fa-home fa-3x"></i> Inicio </a>
                        </li>	
                        <li  >
                                    ...
                                    <table class="table table-striped table-bordered table-hover"  >
                                        <thead style="font-size: 16px" >
                                            ...
                                            <tr >
                                                ...
                                                <th style=" text-align: center">Cursos dicta </th>
                                                <th style=" text-align: center">Fecha disponibilidad</th>
                                                <th style=" text-align: center">Hora</th>
                                                <th style=" text-align: center">Solicitar cita</th>  
                                        ...
                                        <tbody>
                                             <%
                                                for (CitaAcademicaDTO estu : var) {
                                            %>

                                            <tr class="odd gradeX">
                                                <th><%=estu.getIdUsuario().getPrimerApellido() %></th>   
                                                <th><%=estu.getIdasignatura().getDescripcion() %></th>  
                                                <th><%=estu.getIdCurso().getNombreCurso() %></th>  
                                                <th><%=estu.getIdHorario().getFecha() %></th>  
                                                <th><%=estu.getIdHorario().getHora() %></th>  
                                                <th><input style=" height: 20px; width: 100%; margin-bottom: 20px   "  type="checkbox" value=""></th>  
                                                <!--<th><a href="reportedocee.jsp" name="btnEditar"  style="width: 100%" class="btn btn-danger fa fa-pencil-square-o " title="Editar"></a></th-->
