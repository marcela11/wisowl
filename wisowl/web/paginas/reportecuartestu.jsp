<%-- 
    Document   : reportecuartestu
    Created on : 23/02/2015, 05:56:44 PM
    Author     : USER
--%>
...
<html>
    ...
    <head>
        <%
            ...
            LinkedList<NotaDTO> listarC = notdao.listarReportePer(1004);
        ...
        <div id="wrapper">
            <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                   ...
                   <img src="assets/img/favicon.png" class="user-image img-responsive"/> 
                </div>
            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-success">
                                <div class="panel-heading" style="background:#4cae4c;  font-size: 22px; 
                                    ...
                                    Reporte Academico Cuarto Periodo 
                                    ...
                                    <table class="table table-striped table-bordered table-hover"  >
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td style="text-align: center "><%=not.getObservacion()%></td>
                    ...
                    <!-- /. ROW  -->
                    <div class="foot"><a href="generaexcel.jsp" name="btnDescargar" class="btn btn-success square-btn-adjust fa fa-download fa-2x" style=" margin-left:90%; height:40px; width:5%" title="Descargar reporte"></a></div>
                </div>
            </div>
            <!-- /. PAGE INNER  -->
        </div>
