                                    ...
                                    <table class="table table-bordered table-hover"  >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <th><%=not.getNota3()%></th>
                                                <th><%=not.getTotal()%> </th>
                                                <th><%=not.getFechaNota()%></th>
                                                <th><%=not.getObservacion()%></th>

                                                <th style="border:1; cellspacing:0; cellpadding:2 "> <a href="reportedocee.jsp?idEstudiante=<%=not.getIdEstudiante().getIdUsuario()%>" name="btnEditar"  style="width: 100%; margin:0" class="btn btn-success fa fa-search " title="Editar"></a></th>
