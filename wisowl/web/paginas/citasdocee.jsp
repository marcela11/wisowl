    ...
    <body>
        <%
            if (request.getParameter("idEstudiante") != null) {
                ...
                CitaDAO nodao = new CitaDAO();
                CitaAcademicaDTO not = new CitaAcademicaDTO();
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-success">
                                ...
                                <br>
                                <!--div class="col-md-6" -->
                                <form class="form-horizontal"  style="position:relative; left: 200px;" role="form" action="../ControlCita" method="post">
                                       <div class=" form-group input-group input-group-lg" style="width: 600px;">
                                            <input   type="hidden" class="form-control" placeholder="Cita" name="num"  value="<%if (not != null) {
                                                out.print(not.getIdcitaacademico());
                                            }%>" />
                                        <input   type="hidden" class="form-control" placeholder="Estudiante" name="idUsu"  disabled  value="<%if (not != null) {
                                                out.print(not.getIdUsuario().getIdUsuario());
                                            }%> " /> 
                                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                        <input disabled="true" type="text" class="form-control" placeholder="Estudiante" name="Usuario" value="<%if (not != null) {
                                                out.print(not.getIdUsuario().getPrimerApellido());
                                            }%>" />
                                    </div>
                                    <div class=" form-group input-group input-group-lg" style="width: 600px;">
                                       
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                        <input type="date" class="form-control"  placeholder="Curso" name="Curso" value="<%if (not != null) {
                                                out.print(not.getIdCurso().getNombreCurso());
                                            }  %>"/>
                                    </div> 
                                    ...
                                    <div class=" form-group input-group input-group-lg" style="width: 600px;">
                                        ...
                                        <input  type="date" class="form-control" placeholder="Fecha" name="Nota1" value="<%if (not != null) {
                                                out.print(not.getFecha());
                                            } %>" />
                                    </div>
                                    <div class=" form-group input-group input-group-lg" style="width: 600px;">
                                        <span class="input-group-addon"><i class="fa fa-list-ol"></i></span>
                                        <input  type="text" class="form-control"  placeholder="Hora" name="Nota2" value="<%if (not != null) {
                                                out.print(not.getHora());
                                            } %>"  />
                                    </div>   
                                    <div class=" form-group input-group input-group-lg" style="width: 600px;">
                                        <span class="input-group-addon"><i class="fa-file-text-o"></i></span>
                                        <input type="text"  class="form-control" placeholder="Motivo" name="Observacion" value="<%if (not != null) {
                                                out.print(not.getMotivo());
                                            }%>"  />
                                    </div>    
