<%-- 
    Document   : reporteprimeestu
    Created on : 23/02/2015, 05:56:15 PM
    Author     : USER
--%>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-success">
                                <div class="panel-heading" style="background:#4cae4c;  font-size: 22px; 
                                    ...
                                    Reporte Academico Primer Periodo 
                    ...
                    <!-- /. ROW  -->
                    <div class="foot"><a href="generarexcelP.jsp" name="btnDescargar" class="btn btn-success square-btn-adjust fa fa-download fa-2x" style=" margin-left:90%; height:40px; width:5%" title="Descargar reporte"></a></div>
                </div>
            </div>
            <!-- /. PAGE INNER  -->
        </div>
